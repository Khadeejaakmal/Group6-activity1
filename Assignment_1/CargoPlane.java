...
public class CargoPlane extends Airplane implements Cargo {
    ...
    public void displayDetails() {
        System.out.println("Flight Number: " + getFlightNumber() + "," +" Make: " + getMake() + "," +" Type: " + getType() + "," + " Departure Time: " + getDepartureTime() + "," +" Landing Time: " + getLandingTime() + "," +" Flight Duration: " + getFlightDuration() + "," + " Cargo Weight: " + getCargoWeight());
    }
}
